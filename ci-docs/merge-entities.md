...
ms.locfileid: "9304015"
---
# <a name="unify-customer-fields"></a>ग्राहक क्षेत्रों को एकीकृत करें

एकीकरण प्रक्रिया के इस चरण में, अपनी एकीकृत प्रोफ़ाइल इकाई में विलय करने के लिए विशेषताओं को चुनें और बाहर करें। उदाहरण के लिए, यदि तीन निकायों के पास ईमेल डेटा था, तो हो सकता है कि आप सभी तीन अलग-अलग ईमेल फ़ील्ड रखना चाहें या एकीकृत प्रोफ़ाइल के लिए उन्हें एक ईमेल फ़ील्ड में मर्ज करना चाहें। कुछ विशेषताएँ सिस्टम द्वारा स्वचालित रूप से संयुक्त हो जाती हैं। आप स्थिर और अद्वितीय ग्राहक आईडी बना सकते हैं। अलग-अलग ग्राहकों के लिए, आप संबंधित प्रोफाइल को एक क्लस्टर में समूहित कर सकते हैं।

:::image type="content" source="media/m3_unify.png" alt-text="एकीकृत ग्राहक प्रोफ़ाइल को परिभाषित करने वाले मर्ज किए गए फ़ील्ड वाली तालिका दिखाते हुए डेटा एकीकरण प्रक्रिया में ग्राहक फ़ील्ड पृष्ठ को एकीकृत करें।":::

## <a name="review-and-update-the-customer-fields"></a>ग्राहक फ़ील्ड की समीक्षा करें और उन्हें अपडेट करें
...
1. वैकल्पिक रूप से बी-टू-सी के लिए, [परिवारों या समूहों में समूह प्रोफाइल](#group-profiles-into-households-or-clusters).
...
1. निर्दिष्ट करें कि तीन विकल्पों में से किसी एक से फ़ील्ड को कैसे जोड़ा या मर्ज किया जाए:
    - **महत्व**: भाग लेने वाले क्षेत्रों के लिए निर्दिष्ट महत्व रैंक के आधार पर विजेता मान की पहचान करता है. यह डिफ़ॉल्ट मर्ज विकल्प है. महत्व रैंकिंग सेट करने के लिए **ऊपर/नीचे जाएँ** चुनें.
      ...
      > [!NOTE]
      > Customer Insights पहले गैर-शून्य मान का उपयोग करता है। उदाहरण के लिए, दिए गए निकाय A, B, और C को उस क्रम में स्थान दिया गया है, यदि A.Name और B.Name रिक्त हैं, तो C.Name से मान का उपयोग किया जाता है।
...
### <a name="combine-a-group-of-fields"></a>खेतों के समूह को मिलाएं
