...
:::image type="content" source="media/funnel-insights.png" alt-text="फ़नल इनसाइट.":::

> [!NOTE]
> फ़नल इनसाइट्स केवल उन फ़नल चरणों के लिए जेनरेट की जा सकती है जिनमें कस्टम आयाम शामिल **नहीं** होते हैं. अपने फ़नल में सभी चरणों के लिए फ़नल इनसाइट्स जेनरेट करने के लिए, अपने फ़नल चरण बनाने के लिए एंगेजमेंट इनसाइट्स आउट-ऑफ़-बॉक्स आयामों का उपयोग करें. 

आप मुख्य और चरण दोनों स्तरों पर, निम्न श्रेणियों से फ़नल इनसाइट्स देख सकते हैं: 

 - रूपांतरण दर
 -    चेकआउट और खरीदें के बीच रूपांतरण दर 22% है.
 - स्थानांतरण का समय 
 -    कार्ट और चेकआउट के बीच औसत ट्रांज़िशन समय 23 मिनट है. 
 - समापन समय 
 -    ग्राहकों को फ़नल पूरा करने में लगने वाला औसत समय 47 मिनट है. 
...
विभिन्न चरणों में इनसाइट्स की तुलना करने के लिए, इनसाइट्स कार्ड से **चरण विश्लेषण देखें** या **अन्य चरणों की तुलना करें** चुनें. ये फ़नल के प्रत्येक चरण के लिए मीट्रिक की तुलना करने वाला एक बार ग्राफ़ प्रदर्शित करेंगे. 
