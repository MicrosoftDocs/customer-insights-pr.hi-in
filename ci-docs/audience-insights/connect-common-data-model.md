...
1. **एक सामान्य डेटा मॉडल फ़ोल्डर से कनेक्ट करें** का चयन करें, डेटा स्रोत के लिए एक **नाम** दर्ज करें, और **अगला** का चयन करें.
...
1. आप प्रमाणीकरण के लिए संसाधन-आधारित विकल्प और सदस्यता-आधारित विकल्प का उपयोग करके बीच में चयन कर सकते हैं. अधिक जानकारी के लिए, देखें [एक Azure Data Lake Storage Gen2 खाते के लिए एक Azure service principal के साथ ऑडियंस इन्साइट्स को कनेक्ट करें](connect-service-principal.md). **कंटेनर** जानकारी दर्ज करें और **अगला** का चयन करें.
   ...
   > ![Azure Data Lake के लिए कनेक्कशन विवरण दर्ज करने हेतु संवाद बॉक्स](media/enter-new-storage-details.png)

1. **एक सामान्य डेटा मॉडल फ़ोल्डर का चयन करें** संवाद में, उसी से डेटा आयात करने के लिए model.json फ़ाइल का चयन करें, और **अगला** का चयन करें.
   > [!NOTE]
   > परिवेश में किसी अन्य डेटा स्रोत से जुड़ी कोई भी model.json फाइल सूची में नहीं दिखाई देगी.

1. आपको चयनित model.json फ़ाइल में उपलब्ध निकायों की सूची मिलेगी. आप उपलब्ध निकायों की सूची की समीक्षा कर सकते हैं और उनमें से चुयन करके **सहेजें** चुन सकते हैं. सभी चयनित निकाय नए डेटा स्रोत से इन्जेस्ट किए जायेंगे.
   > [!div class="mx-imgBorder"]
...
> [!NOTE]
> एक model.json फ़ाइल उसी परिवेश में केवल एक ही डेटा स्रोत के साथ संबद्ध हो सकता है. हालांकि, एक ही model.json फ़ाइल कई परिवेश में डेटा स्रोतों के लिए इस्तेमाल किया जा सकता है.

## <a name="edit-a-common-data-model-folder-data-source"></a>एक Common Data Model फ़ोल्डर डेटा स्रोत संपादित करें

आप सामान्य डेटा मॉडल फ़ोल्डर वाले स्टोरेज खाते के लिए एक्सेस कुंजी को अपडेट कर सकते हैं. आप model.json फ़ाइल भी बदल सकते हैं. अपने संग्रहण खाते से एक अलग कंटेनर से कनेक्ट करने के लिए, या खाता नाम बदलने के लिए, [एक नया डेटा स्रोत कनेक्शन बनाएं](#connect-to-a-common-data-model-folder).
...
5. वैकल्पिक रूप से, आप खाते की कुंजी कनेक्शन से संसाधन-आधारित या सदस्यता-आधारित कनेक्शन में अपडेट कर सकते हैं. अधिक जानकारी के लिए, देखें [एक Azure Data Lake Storage Gen2 खाते के लिए एक Azure service principal के साथ ऑडियंस इन्साइट्स को कनेक्ट करें](connect-service-principal.md). कनेक्शन अपडेट करते समय आप **कंटेनर** जानकारी नहीं बदल सकते.
   > [!div class="mx-imgBorder"]
   > ![Azure Data Lake के लिए कनेक्कशन विवरण दर्ज करने हेतु संवाद बॉक्स](media/enter-existing-storage-details.png)

6. वैकल्पिक रूप से, निकायों के एक भिन्न सेट के साथ भिन्न model.json फ़ाइल को चुनें.
...
7. वैकल्पिक रूप से, आप इन्जेस्ट करने के लिए अतिरिक्त निकायों का चयन कर सकते हैं. निर्भरता न होने पर आप पहले से ही चयनित निकायों को हटा भी सकते हैं.
   ...
   > [!IMPORTANT]
   > यदि विद्यमान model.json फ़ाइल और संस्थाओं के सेट पर निर्भरताएं हैं, तो आपको एक त्रुटि संदेश दिखाई देगा और एक भिन्न model.json फ़ाइल को चुना नहीं जा सकता है. Model.json फ़ाइल को बदलने से पहले उन निर्भरताओं को हटाएं अथवा model.json फ़ाइल के साथ एक नया डेटा स्रोत बनाएँ जिसका उपयोग आप निर्भरताओं को हटाने से बचने के लिए करना चाहते हैं.
