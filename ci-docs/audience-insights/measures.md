...
1. **नाम संपादित करें** चुनें और उपाय के लिए एक **नाम** प्रदान करें. 
   > [!NOTE]
   > यदि आपके नए माप कॉन्फ़िगरेशन में केवल दो फ़ील्ड हैं—उदाहरण के लिए, CustomerID और एक गणना हैं—तो आउटपुट को Customer_Measure नाम के सिस्टम द्वारा जनरेट किए गए निकाय में एक नए कॉलम के रूप में जोड़ा जाएगा। और आप एकीकृत ग्राहक प्रोफ़ाइल में उपाय के मान को देख पाएंगे. अन्य उपाय उनकी अपने निकाय उत्पन्न करेंगे.
