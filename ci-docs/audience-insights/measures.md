...
उपाय आपको ग्राहक व्यवहार और व्यावसायिक प्रदर्शन को बेहतर ढंग से समझने में मदद करते हैं. वे [एकीकृत प्रोफ़ाइल](data-unification.md) से प्रासंगिक मानों को देखते हैं. उदाहरण के लिए, एक व्यवसाय किसी एक ग्राहक की खरीद इतिहास को समझने या पूरे व्यवसाय में कुल स्तर के राजस्व को समझने के लिए *कंपनी की कुल बिक्री* को मापने के लिए *प्रति ग्राहक कुल खर्च* देखना चाहता है.  
...
1. **नाम संपादित करें** चुनें और उपाय के लिए एक **नाम** प्रदान करें. 
   > [!NOTE]
   > यदि आपके नए माप कॉन्फ़िगरेशन में केवल दो फ़ील्ड हैं, उदाहरण के लिए, CustomerID और एक गणना हैं, तो आउटपुट को Customer_Measure नाम के सिस्टम द्वारा उत्पन्न निकाय में एक नए कॉलम के रूप में जोड़ा जाएगा. और आप एकीकृत ग्राहक प्रोफ़ाइल में उपाय के मान को देख पाएंगे. अन्य उपाय उनकी अपने निकाय उत्पन्न करेंगे.
...
1. यदि आपके डेटा में ऐसे मान हैं जिन्हें आपको पूर्णांक से बदलने की आवश्यकता है, उदाहरण के लिए, *शून्य* को *0* के साथ बदलना है, तो **नियम** चुनें. नियम को कॉन्फ़िगर करें और सुनिश्चित करें कि आप केवल पूर्णांकों को प्रतिस्थापन के रूप में चुनते हैं.
...
1. **समयावधि सेट करें** अनुभाग में, उपयोग करने के लिए डेटा की समय सीमा को परिभाषित करें. यदि आप **पूरे समय** का चयन करके पूरे डेटा सेट को कवर करने के लिए नया उपाय चाहते हैं तो चुनें. या यदि आप एक **विशिष्ट समयावधि** पर ध्यान केंद्रित करने के लिए उपाय चाहते हैं.
