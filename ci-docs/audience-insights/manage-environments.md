...
> 1. कोई मौजूदा Customer Insights परिवेश पहले से उससे संबद्ध नहीं है Dataverse वातावरण। करना सीखें [a . से मौजूदा कनेक्शन को हटा दें Dataverse वातावरण](#remove-an-existing-connection-to-a-dataverse-environment).
...
1. हमारे इंजीनियर से चलाने के लिए आवश्यक दो पावरशेल स्क्रिप्ट डाउनलोड करें [गिटहब रेपो](https://github.com/trin-msft/byol).
    1. `CreateSecurityGroups.ps1`
       ...
       - इस स्क्रिप्ट द्वारा उत्पन्न दोनों सुरक्षा समूह आईडी मान सहेजें क्योंकि हम उनका उपयोग करेंगे`ByolSetup.ps1` स्क्रिप्ट
    ...
    2. `ByolSetup.ps1`
        ...
        - यह पॉवरशेल स्क्रिप्ट इसके लिए आवश्यक टोल-आधारित एक्सेस कंट्रोल (RBAC) जोड़ती है Microsoft Dataverse सेवा और कोई भीDataverse -आधारित व्यावसायिक अनुप्रयोग। यह इसके साथ बनाए गए सुरक्षा समूहों के लिए CustomerInsights कंटेनर पर एक्सेस कंट्रोल लिस्ट (ACL) को भी अपडेट करता है`CreateSecurityGroups.ps1` स्क्रिप्ट सहयोगी समूह के पास होगा*आरडब्ल्यूएक्स* अनुमति और पाठक समूह के पास होगा*आरएक्स* केवल अनुमति।
...
1. चुनते हैं **समीक्षा करें और समाप्त करें**, फिर **अद्यतन** परिवर्तनों को लागू करने के लिए। 

## <a name="claim-ownership-of-an-environment"></a>किसी परिवेश के स्वामित्व का दावा करें

यदि किसी परिवेश का स्वामी संगठन छोड़ देता है या उनका उपयोगकर्ता खाता हटा दिया जाता है, तो परिवेश का कोई स्वामी नहीं होगा। व्यवस्थापक अनुमतियों वाला उपयोगकर्ता स्वामित्व का दावा कर सकता है और नया स्वामी बन सकता है। वे पर्यावरण के मालिक बने रह सकते हैं या[स्वामित्व को किसी अन्य व्यवस्थापक में बदलें](#change-the-owner-of-an-environment). 
