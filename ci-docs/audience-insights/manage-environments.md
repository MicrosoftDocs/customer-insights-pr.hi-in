...
6. वैकल्पिक रूप से, आप Microsoft Dataverse के साथ डेटा साझा करना कॉन्फ़िगर करें और अतिरिक्त क्षमताओं को सक्षम करें **के तहत Microsoft Dataverse परिवेश का URL प्रदान कर सकते हैं**. ये क्षमताएं Microsoft Dataverse के आधार पर अनुप्रयोगों और समाधानों के साथ डेटा साझा करने, ऑन-प्रीमाइसेस डेटा स्रोतों से डेटा इंजेस्चन करने या [पूर्वानुमानों](predictions.md) का उपयोग शामिल करती हैं. **डेटा साझाकरण सक्षम करें** को चुनें, ताकि Microsoft Dataverse प्रबंधित Data Lake के साथ Customer Insights आउटपुट डेटा साझा किया जा सके.
   ...
   एक बार जब आप Microsoft Dataverse के साथ डेटा साझा करना सक्षम करते हैं, तो आपके डेटा स्रोतों और अन्य प्रक्रियाओं का पूरा रिफ़्रेश ट्रिगर हो जाएगा. यदि प्रक्रियाएं वर्तमान में चल रही हैं और कतारबद्ध हैं, तो आपको Microsoft Dataverse के साथ डेटा साझा करने में सक्षम करने का विकल्प नहीं दिखाई देगा. आप डेटा साझा करने को सक्षम करने के लिए उन प्रक्रियाओं को पूरा करने या रद्द करने की प्रतीक्षा कर सकते हैं. 
