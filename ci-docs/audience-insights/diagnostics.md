...
- **ऑपरेशनल इवेंट्स**
  - **कार्यप्रवाह घटना** - वर्कफ़्लो किसी को सेट करने की अनुमति देता है [डाटा के स्रोत](data-sources.md),[यूनिफाई](data-unification.md) तथा[समृद्ध](enrichment-hub.md) और अंत में [निर्यात](export-destinations.md) अन्य प्रणालियों में डेटा। उन सभी चरणों को व्यक्तिगत रूप से किया जा सकता है (उदाहरण के लिए एक निर्यात ट्रिगर) या ऑर्केस्ट्रेटेड (उदाहरण डेटा स्रोतों से डेटा रीफ्रेश जो एकीकरण प्रक्रिया को ट्रिगर करता है जो अतिरिक्त संवर्धन में खींचेगा और एक बार डेटा को किसी अन्य सिस्टम में निर्यात करेगा)। अधिक जानकारी के लिए देखें [वर्कफ़्लोइवेंट स्कीमा](#workflow-event-schema).
