...
1. चुनें **किरायेदार** गंतव्य संसाधन के साथ Azure सदस्यता का चयन करें और **लॉग इन करें**.
...
| क्षेत्र             | डाटा प्रकार  | आवश्यक/वैकल्पिक | विवरण       | उदाहरण        |
| ----------------- | --------- | ----------------- | --------------------- | ------------------------ |
...
| `properties`      | String    | वैकल्पिक          | घटनाओं की विशेष श्रेणी के लिए अधिक गुणों के साथ JSON ऑब्जेक्ट।      | देखो[गुण](#api-properties-schema) अनुभाग।    |
...
| `Claims`                      | उपयोगकर्ता या ऐप के दावे JSON वेब टोकन (JWT)। दावा गुण प्रति संगठन अलग-अलग होते हैं और Azure Active Directory विन्यास। |
