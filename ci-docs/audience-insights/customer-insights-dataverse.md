...
description: Microsoft Dataverse में तालिका के रूप में Customer Insights निकायों का उपयोग करें.
ms.date: 11/25/2021
ms.reviewer: mhart
...
ms.locfileid: "7866936"
---
# <a name="work-with-customer-insights-data-in-microsoft-dataverse"></a>Microsoft Dataverse . में Customer Insights डेटा के साथ काम करें

Customer Insights आउटपुट संस्थाओं को उपलब्ध कराने का विकल्प प्रदान करता है [Microsoft Dataverse](/powerapps/maker/data-platform/data-platform-intro.md). यह एकीकरण लो कोड / नो कोड दृष्टिकोण के माध्यम से डेटा साझाकरण को आसान और कस्टम विकास को सक्षम बनाता है. आउटपुट इकाइयां Dataverse में टेबल के रूप में उपलब्ध होंगी। ये तालिकाएँ परिदृश्यों को सक्षम करती हैं जैसे [Power Automate . के माध्यम से स्वचालित कार्यप्रवाह](/power-automate/getting-started),[मॉडल-चालित ऐप्स](/powerapps/maker/model-driven-apps/) तथा[कैनवास ऐप्स](/powerapps/maker/canvas-apps/) Power Apps के माध्यम से। आप किसी अन्य एप्लिकेशन के लिए डेटा का उपयोग कर सकते हैं जो Dataverse तालिकाओं पर आधारित है। वर्तमान कार्यान्वयन मुख्य रूप से लुकअप का समर्थन करता है जहां उपलब्ध ऑडियंस इनसाइट निकाय से किसी दिए गए ग्राहक ID के लिए डेटा निकाला जा सकता है.

## <a name="attach-a-dataverse-environment-to-customer-insights"></a>Customer Insights में Dataverse वातावरण संलग्न करें

**मौजूदा Dataverse वातावरण वाले संगठन**

संगठन जो पहले से ही Dataverse का उपयोग कर सकते हैं [उनके मौजूदा Dataverse परिवेशों में से किसी एक का उपयोग करें](create-environment.md) जब कोई व्यवस्थापक ऑडिएंस अंतर्दृष्टि सेट करता है। Dataverse परिवेश को URL प्रदान करके, यह उनके नए ऑडिएंस इनसाइट परिवेश से जोड़ रहा है। सर्वोत्तम संभव प्रदर्शन सुनिश्चित करने के लिए, Customer Insights और Dataverse परिवेशों को एक ही क्षेत्र में होस्ट किया जाना चाहिए।

**नया संगठन**

यदि आप Customer Insights को सेट करते समय एक नया संगठन बनाते हैं, तो आपको स्वचालित रूप से एक नया Dataverse वातावरण प्राप्त हो जाएगा।

> [!NOTE]
> यदि आपके संगठन अपने टैनेंट में पहले से ही Dataverse का उपयोग करते हैं, तो यह याद रखना महत्वपूर्ण है [Dataverse पर्यावरण निर्माण एक व्यवस्थापक द्वारा नियंत्रित किया जाता है](/power-platform/admin/control-environment-creation.md) . उदाहरण के लिए, यदि आप अपने संगठनात्मक खाते के साथ एक नया ऑडिएंस अंतर्दृष्टि वातावरण स्थापित कर रहे हैं और व्यवस्थापक ने व्यवस्थापकों को छोड़कर सभी के लिए Dataverse परीक्षण वातावरण बनाना अक्षम कर दिया है, तो आप एक नया परीक्षण वातावरण नहीं बना सकते।
> 
> Customer Insights में बनाए गए Dataverse परीक्षण परिवेशों में 3 GB संग्रहण है जो टैनेंट की संपूर्ण क्षमता में नहीं गिना जाएगा. पेड सब्सक्रिप्शन को Dataverse डेटाबेस के लिए 15 जीबी और फाइल स्टोरेज के लिए 20 जीबी की पात्रता मिलती है।

## <a name="output-entities"></a>आउटपुट निकाय

ऑडिएंस अंतर्दृष्टि से कुछ आउटपुट इकाइयां Dataverse में तालिका के रूप में उपलब्ध हैं। नीचे दिए गए खंड इन तालिकाओं के अपेक्षित स्कीमा का वर्णन करते हैं.
...
|KeyRing           | बहुरेखीय टेक्स्ट        | JSON मान  </br> नमूना: [{"dataSourceName":" datasource5 ",</br>"entityName": "संपर्क1",</br>"preferredKey":" cntid_1078",</br>"कुंजी":[" cntid_1078"]}]       |
