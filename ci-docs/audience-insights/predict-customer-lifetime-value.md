...
ms.locfileid: "5268596"
---
# <a name="customer-lifetime-value-clv-prediction-preview"></a>ग्राहक जीवनकाल मान (CLV) पूर्वानुमान (पूर्वावलोकन)
...
- लेन-देन का इतिहास: नीचे सिमेंटिक डेटा स्कीमा के साथ ऐतिहासिक लेन-देन लॉग
    - लेन-देन ID: प्रत्येक लेन-देन का विशिष्ट पहचानकर्ता
    - लेन-देन की तारीख: दिनांक, अधिमानतः प्रत्येक लेन-देन का टाइम स्टैम्प
    - लेन-देन की राशि: प्रत्येक लेन-देन का मौद्रिक मूल्य (उदाहरण के लिए, राजस्व या लाभ मार्जिन)
    - रिटर्न (वैकल्पिक) को सौंपा गया लेबल: बूलियन मूल्य यह दर्शाता है कि क्या लेन-देन वापसी है 
...
- ग्राहक गतिविधियों के बारे में डेटा (वैकल्पिक):
    ...
    - गतिविधियों के लिए सिमेंटिक डेटा स्कीमा में शामिल हैं: 
        - प्राथमिक कुंजी: एक गतिविधि के लिए अद्वितीय पहचानकर्ता
        - टाइमस्टैम्प: प्राथमिक कुंजी द्वारा पहचानी गई घटना की तारीख और समय
        - ईवेंट (गतिविधि का नाम): ईवेंट का नाम जिसे आप उपयोग करना चाहते हैं
...
1. **ग्राहक जीवनकाल मूल्य (पूर्वावलोकन)** फलक में, **प्रारंभ करें** चुनें.
...
1. CLV का पूर्वानुमान करने के लिए आप भविष्य में कितनी दूर जाना चाहते हैं, यह निर्धारित करने के लिए **पूर्वानुमान समय अवधि** सेट करें.    
   ...
   > [!TIP]
   > आपके द्वारा निर्धारित समय अवधि के लिए CLV का सटीक पूर्वानुमान करने के लिए, आपको ऐतिहासिक डेटा की तुलनीय अवधि की आवश्यकता है. उदाहरण के लिए, यदि आप अगले 12 महीनों के लिए भविष्यवाणी करना चाहते हैं, तो यह सिफारिश की जाती है कि आपके पास कम से कम 18 – 24 महीने का ऐतिहासिक डेटा हो.
...
1. **डेटा अपडेट शेड्यूल** चरण में, नवीनतम डेटा के आधार पर अपने मॉडल को पुनः प्राप्त करने की आवृत्ति चुनें. यह सेटिंग पूर्वानुमानों की सटीकता को अद्यतन करने के लिए महत्वपूर्ण है क्योंकि ऑडियंस इनसाइट्स में नए डेटा का उपयोग किया जाता है. अधिकांश व्यवसाय प्रति माह एक बार फिर से सिखा सकते हैं और उनके पूर्वानुमान के लिए अच्छी सटीकता प्राप्त कर सकते हैं.
...
- **प्रशिक्षण मॉडल प्रदर्शन**: ए, बी या सी संभावित ग्रेड हैं. यह ग्रेड पूर्वानुमान के प्रदर्शन को दर्शाता है और आउटपुट निकाय में स्टोर परिणामों का उपयोग करने का निर्णय लेने में आपकी सहायता कर सकता है. **इस स्कोर के बारे में जानें** को चुनें, ताकि अंतर्निहित मॉडल प्रदर्शन मैट्रिक्स और अंतिम मॉडल प्रदर्शन ग्रेड कैसे प्राप्त किया गया था को बेहतर ढंग से समझ सकें.
  ...
  - ए जब मॉडल ने बेसलाइन मॉडल की तुलना में कम से कम 5% अधिक मूल्य वाले ग्राहकों का पूर्वानुमान किया था.
  - बी जब बेसलाइन मॉडल की तुलना में मॉडल ने 0-5% अधिक मूल्य वाले ग्राहकों के बीच सटीक पूर्वानुमान किया गया.
  - सी जब बेसलाइन मॉडल की तुलना में मॉडल ने कम उच्च-मूल्य वाले ग्राहकों का सटीक पूर्वानुमान लगाया था.
  ...
  *प्रत्येक ग्राहक के लिए CLV = सक्रिय ग्राहक विंडो में ग्राहक द्वारा की गई औसत मासिक खरीद * CLV पूर्वानुमान अवधि में महीनों की संख्या * सभी ग्राहकों की समग्र अवधारण दर*
...
सेटिंग्स में कॉन्फ़िगर किए गए के अनुसार पूर्वानुमान [अपने डेटा रीफ्रेश शेड्यूल करें](system.md#schedule-tab) पर स्वतः ही रीफ्रेश होते हैं. आप मैन्युअल रूप से भी रीफ़्रेश कर सकते हैं.

1. **इंटेलिजेंस** > **पूर्वानुमानों** पर जाएं और **मेरे पूर्वानुमान** टैब का चयन करें.
2. पूर्वानुमान के बगल में उस लंबवत दीर्घवृत्त का चयन करें, जिसे आप रिफ्रेश करना चाहते हैं.
3. **रिफ्रेश** को चुनें.
...
1. **इंटेलिजेंस** > **पूर्वानुमानों** पर जाएं और **मेरे पूर्वानुमान** टैब का चयन करें.
2. आप जिस पूर्वानुमान को हटाना चाहते हैं, उसके बगल में लंबवत दीर्घवृत्त चुनें.
3. **हटाएँ** चुनें.

## <a name="troubleshoot-a-failed-prediction"></a>एक असफल पूर्वानुमान को ठीक करें

1. **इंटेलिजेंस** > **पूर्वानुमानों** पर जाएं और **मेरे पूर्वानुमान** टैब का चयन करें.
2. आप जिस पूर्वानुमान के लिए त्रुटि लॉग देखना चाहते हैं, उसके बगल में लंबवत दीर्घवृत्त चुनें.
3. **लॉग** चुनें.
4. सभी त्रुटियों की समीक्षा करें. कई प्रकार की त्रुटियां हो सकती हैं और वे बताती हैं कि त्रुटि किस कारण से हुई. उदाहरण के लिए, एक त्रुटि जिसके बारे में सटीक पूर्वानुमान करने के लिए पर्याप्त डेटा नहीं है, को आमतौर पर ऑडियंस इनसाइट्स में अधिक डेटा लोड करके हल किया जाता है.
