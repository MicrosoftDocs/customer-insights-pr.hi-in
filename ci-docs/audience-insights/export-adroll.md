...
- आप एक बार में AdRoll से 250,000 प्रोफ़ाइलें तक निर्यात कर सकते हैं.
- आप 100 से कम प्रोफ़ाइल वाले सेगमेंट AdRoll पर निर्यात नहीं कर सकते. 
- AdRoll पर निर्यात करना सेगमेंट पर सीमित है.
- 250,000 प्रोफ़ाइलों को AdRoll पर निर्यात करने में 10 मिनट तक का समय लग सकता है। 
- आपके द्वारा AdRoll में निर्यात की जा सकने वाली प्रोफ़ाइलों की संख्या AdRoll के साथ आपके अनुबंध पर निर्भर है।
