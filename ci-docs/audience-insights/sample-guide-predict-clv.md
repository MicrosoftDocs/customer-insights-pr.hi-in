...
[डेटा अंतर्ग्रहण संबंधित](data-sources.md) आलेखों की समीक्षा और [Power Query कनेक्टर्स का उपयोग करके डेटा स्रोत आयात करना](connect-power-query.md). निम्नलिखित जानकारी मानती है कि आप सामान्य रूप से इन्जेस्ट होते डेटा से परिचित हैं.
...
एकीकृत ग्राहक प्रोफाइल के साथ, अब हम ग्राहक जीवनकाल मान पूर्वानुमान चला सकते हैं. विस्तृत चरणों के लिए, [ग्राहक आजीवन मूल्य पूर्वानुमान (पूर्वावलोकन)](predict-customer-lifetime-value.md) देखें.
