...
लेखों की समीक्षा करें [डेटा अंतर्ग्रहण के बारे में](data-sources.md) तथा[डेटा स्रोतों का उपयोग कर आयात करनाPower Query कनेक्टर्स](connect-power-query.md) विशेष रूप से। निम्नलिखित जानकारी मानती है कि आप सामान्य रूप से इन्जेस्ट होते डेटा से परिचित हैं.
