...
1. ड्राप-डाउन से एक [कनेक्शन](connections.md) चुनें. यदि कोई कनेक्शन उपलब्ध नहीं है तो किसी व्यवस्थापक से संपर्क करें. यदि आप एक व्यवस्थापक हैं, तो आप **कनेक्शन जोड़ें** का चयन करके और ड्रॉप-डाउन से **SFTP कस्टम आयात** चुनकर एक कनेक्शन बना सकते हैं.

1. चयनित कनेक्शन की पुष्टि करने के लिए **कस्टम इम्पोर्ट से कनेक्ट करें** का चयन करें.

1.  **अगला** चुनें और उस डेटा फ़ाइल का **फ़ाइलनाम** और **पाथ** दर्ज करें जिसे आप आयात करना चाहते हैं.
...
1. STFP सर्वर के लिए वैध उपयोगकर्ता नाम, पासवर्ड और होस्ट URL दर्ज करें आयात किए जाने वाले डेटा पर रहता है.
...
1. एक बार सत्यापन पूरा हो जाने के बाद, कनेक्शन को **सहेजें** क्लिक करके बचाया जा सकता है.

> [!div class="mx-imgBorder"]
   > ![एक्सपीरियन कनेक्शन कॉन्फ़िगरेशन पृष्ठ](media/enrichment-SFTP-connection.png "एक्सपीरियन कनेक्शन कॉन्फ़िगरेशन पृष्ठ")
