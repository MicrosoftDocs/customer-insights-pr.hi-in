...
1. दाएं हाथ के फलक पर 'नाम' फ़ील्ड में, अपने डेटा स्रोत का नाम **क्वेरी** से **eCommerceContacts** में बदलें
...
1. दाएं फलक पर 'नाम' फ़ील्ड में, अपने डेटा स्रोत का नाम **क्वेरी** से **eCommercePurchases** बदलें.
...
1. दाएँ-बाएँ फलक पर 'नाम' फ़ील्ड में, अपना डेटा स्रोत नाम बदलें **सवाल** सेवा**loyCustomers**.
...
1. **खरीद इतिहास (आवश्यक)** का चयन करें और सदस्यता का इतिहास के लिए **डेटा जोड़ें** चुनें.
