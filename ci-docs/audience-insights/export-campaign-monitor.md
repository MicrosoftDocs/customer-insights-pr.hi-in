...
---
# <a name="export-segment-lists-to-campaign-monitor-preview"></a>सेगमेंट सूचियां को Campaign Monitor (पूर्वावलोकन) में निर्यात करें
...
- आप Campaign Monitor करने के लिए प्रति निर्यात 1 मिलियन प्रोफ़ाइल तक निर्यात कर सकते हैं.
- Campaign Monitor को निर्यात करना सेगमेंट तक ही सीमित है.
- Campaign Monitor को 1 मिलियन प्रोफ़ाइल तक निर्यात पूरा करनें में 20 मिनट तक का समय लग सकता है. 
- प्रोफ़ाइल की संख्या है कि आप Campaign Monitor करने के लिए निर्यात कर सकते है निर्भर है और Campaign Monitor के साथ अपने अनुबंध पर सीमित है.
...
3. **डेटा मिलान** अनुभाग में, **ईमेल** फ़ील्ड में, अपने एकीकृत ग्राहक प्रोफ़ाइल में उस फ़ील्ड का चयन करें जो ग्राहक के ईमेल पते का प्रतिनिधित्व करता है. Campaign Monitor करने के लिए सेगमेंट का निर्यात करना आवश्यक है.
