...
खेतों के समूह को एक इकाई के रूप में मानें। उदाहरण के लिए, जब हमारे रिकॉर्ड में पता1, पता2, शहर, राज्य और ज़िप फ़ील्ड होते हैं। हम संभवत: किसी भिन्न रिकॉर्ड के पते 2 में विलय नहीं करना चाहते हैं, यह सोचकर कि यह हमारे डेटा को और अधिक पूर्ण बना देगा

1. पर **मर्ज** पेज, चुनें **जोड़ना।**

1. चुने **खेतों का समूह** विकल्प।

1. इसमें मर्ज विजेता नीति निर्दिष्ट करें **रैंक समूहों द्वारा** ड्रॉप डाउन।

1. चुनते हैं **जोड़ें** और चुनें कि क्या आप फ़ील्ड में अधिक फ़ील्ड या अतिरिक्त समूह जोड़ना चाहते हैं।

1. उपलब्ध करें **नाम** और एक **आउटपुट का नाम** प्रत्येक संयुक्त क्षेत्र के लिए।

1. उपलब्ध करें **नाम** खेतों के समूह के लिए। 
