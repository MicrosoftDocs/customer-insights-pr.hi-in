...
1. अपलोड करने के बाद फाइलें और निकाय उपलब्ध हैं, फिर से **कस्टम मिलान** विकल्प चुनें. आप जिन निकायों को शामिल करना चाहते हैं उन्हें निर्दिष्ट करने के लिए विकल्प देखेंगे. ड्रॉपडाउन मेनू से आवश्यक निकाय चुनें और चुनें **किया हुआ**.
...
1. कस्टम मिलान लागू करना उस मिलान विकल्प पर निर्भर करता है जिसका आप उपयोग करना चाहते हैं। 
   ...
   - के लिये **कस्टम बाईपास** या**उपनाम मानचित्रण**, चुनते हैं **संपादित करें** किसी मौजूदा मिलान नियम पर या एक नया नियम बनाएँ। सामान्यीकरण ड्रॉपडाउन में, चुनें **कस्टम बाईपास** या**उपनाम मानचित्रण** विकल्प और चुनें **किया हुआ**.
...
- यदि सिमेंटिक प्रकार की सेटिंग को इसमें हटा दिया जाता है **नक्शा** चरण जब मिलान नियम उपनाम मैपिंग या कस्टम बायपास का उपयोग करता है, तो सामान्यीकरण लागू नहीं किया जाएगा। यह केवल तभी होता है जब आप मिलान नियम में सामान्यीकरण को कॉन्फ़िगर करने के बाद सिमेंटिक प्रकार को साफ़ करते हैं क्योंकि सिमेंटिक प्रकार अज्ञात होगा।
