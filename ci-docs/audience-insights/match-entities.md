...
प्रत्येक मिलान एक एकल, समेकित निकाय में दो या अधिक निकायों को एकीकृत करता है. इसी समय, यह विशिष्ट ग्राहक रिकॉर्ड रखता है. उदाहरण के लिए, हमने दो निकायों का चयन किया: प्राथमिक निकाय के रूप में **eCommerce:eCommerceContacts** और दूसरे निकाय के रूप में **LoyaltyScheme:loyCustomers**. निकायों का क्रम निर्दिष्ट करता है कि किस क्रम में सिस्टम रिकॉर्ड से मिलान करने का प्रयास करेगा.
...
प्राथमिक निकाय *eCommerce:eCommerceContacts* का मिलान अगले निकाय *LoyaltyScheme:loyCustomers* के साथ किया जाता है. यदि आपके पास दो से अधिक निकाय हैं, तो पहले मिलान चरण से प्राप्त डेटासेट निम्न निकाय के साथ मेल खाता है.
...
> - उस निकाय को चुनें जिसमें प्राथमिक निकाय के रूप में अन्य निकायों (उदाहरण के लिए, नाम, फ़ोन नंबर, या ईमेल पते) के साथ आम तौर पर कई विशेषताएं हैं.

मिलान के क्रम को निर्दिष्ट करने के बाद, आपको **डेटा** > **Unify** > **मिलान** पर **मिलान किए गए रिकॉर्ड विवरण** अनुभाग में परिभाषित मिलान जोड़े दिखाई देंगे. जब तक मिलान की प्रक्रिया पूरी नहीं हो जाती, तब तक प्रमुख मैट्रिक्स खाली रहेंगे.
...
1. मिलान नियमों को परिभाषित करने के लिए **मिलान किए गए रिकॉर्ड विवरण** अनुभाग में निकाय के अंतर्गत **नियम जोड़ें** का चयन करें.
...
1. **नियम बनाएं** फलक में, नियम के लिए शर्तों को कॉन्फ़िगर करें.
   ...
   - **सामान्यीकृत**: चयनित विशेषताओं के लिए सामान्यीकरण विकल्प चुनें. 
     ...
     - शब्दार्थ प्रकार: नाम, शीर्षक, फोन नंबर, पते आदि को मानकीकृत करता है. 

   - **परिशुद्धता**: इस शर्त को लागू करने के लिए सटीक स्तर निर्धारित करें. 
     - **बुनियादी**: *कम*, *मध्यम*, *उच्च* और *सटीक* से चुनें. **सटीक** का चयन केवल उन रिकॉर्ड से मिलान करने के लिए करें जो 100 प्रतिशत मेल खाते हों. रिकॉर्ड से मेल खाने के लिए अन्य स्तरों में से एक का चयन करें,जो 100 प्रतिशत समान नहीं हैं.
...
वे मिलान नियम जो शर्तों के सेट को दर्शाते हैं. कई विशेषताओं के आधार पर शर्तों से निकायों का मिलान करने के लिए, और नियम जोड़ें
...
डीडुप्लीकेटेड रिकॉर्ड का उपयोग क्रॉस-निकाय मिलान प्रक्रिया में किया जाएगा. डीडुप्लीकेशन अलग-अलग निकायों पर होता है और मिलान जोड़े में इस्तेमाल होने वाले प्रत्येक निकाय को कॉन्फ़िगर किया जा सकता है.
...
1. **मर्ज डुप्लिकेट** अनुभाग में, **सेट निकायों का चयन करें**. यदि डीडुप्लीकेशन नियम पहले से बने हुए हैं, तो **संपादित करें** चुनें.
...
1. [मिलान प्रक्रिया रन करने](#run-the-match-process) के बाद, आपको मुख्य मैट्रिक्स टाइलों में डीडुप्लीकेट के आंकड़े दिखाई देंगे.
...
आप कुछ ऐसी शर्तें निर्दिष्ट कर सकते हैं कि कुछ रिकॉर्ड हमेशा मेल खाएँ या कभी मेल न खाएँ. इन नियमों को मानक मिलान प्रक्रिया को ओवरराइड करने के लिए अपलोड किया जा सकता है. उदाहरण के लिए, यदि हमारे रिकॉर्ड में जॉन डो I और जॉन डो II हैं, तो सिस्टम उन्हें एक व्यक्ति के रूप में मिलान कर सकता है. कस्टम मिलान नियम आपको यह निर्दिष्ट करने देते हैं कि उनकी प्रोफ़ाइल विभिन्न लोगों को संदर्भित करती है. 
...
1. यदि आपके पास कोई कस्टम मिलान नियम सेट नहीं है, तो आपको अधिक विवरण के साथ एक नया **कस्टम मिलान** फलक दिखाई देगा.

1. चयन करें **टेम्पलेट में भरें** एक टेम्प्लेट फ़ाइल प्राप्त करने के लिए जो यह निर्दिष्ट कर सकती है कि किन रिकॉर्ड्स से हमेशा मिलान होना चाहिए या कभी मिलान नहीं होना चाहिए. आपको दो अलग-अलग फ़ाइलों में "हमेशा मिलान" रिकॉर्ड और "कभी मिलान नहीं" रिकॉर्ड भरने की आवश्यकता होगी.

1. टेम्पलेट में फ़ील्ड और निकाय प्राथमिक कुंजी मान निर्दिष्ट करने के लिए कस्टम मिलान में उपयोग किए जाने वाले फ़ील्ड होते हैं. उदाहरण के लिए, यदि आप चाहते हैं कि *विक्रय* निकाय से प्राथमिक कुंजी *12345* हमेशा *संपर्क* निकाय से प्राथमिक कुंजी *34567* से मेल खाए, तो टेम्पलेट भरें:
    - निकाय1: विक्रय
    - निकाय1कुंजी: 12345
    - निकाय2: संपर्क
    - निकाय2कुंजी: 34567
...
1. जिन ओवरराइड्स को आप लागू करना चाहते हैं, उन्हें जोड़ने के बाद टेम्पलेट फ़ाइल को सहेजें.

1. **डेटा** > **डेटा स्रोत** पर जाएं और टेम्पलेट फ़ाइलों को नए निकायों के रूप में अंतर्ग्रहण करें. अंतर्ग्रहण के बाद, आप उनका उपयोग मिलान कॉन्फ़िगरेशन निर्दिष्ट करने के लिए कर सकते हैं.

1. अपलोड करने के बाद फाइलें और निकाय उपलब्ध हैं, फिर से **कस्टम मिलान** विकल्प चुनें. आप जिन निकायों को शामिल करना चाहते हैं उन्हें निर्दिष्ट करने के लिए विकल्प देखेंगे. ड्रॉप-डाउन मेनू से आवश्यक निकाय चुनें.
...
1. उन निकायों का चयन करें जिन्हें आप **हमेशा मिलान** के लिए और **कभी मिलान नहीं** के लिए उपयोग करना चाहते हैं, **सम्पन्न** का चयन करें.
...
> [!TIP]
> **डेटा** > **निकायों** पर जाएं और ओवरराइड लागू होने की पुष्टि करने के लिए **ConflationMatchPair** निकाय की समीक्षा करें.
