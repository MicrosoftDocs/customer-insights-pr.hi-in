---
title: अनुभागों को Snapchat (पूर्वावलोकन) में निर्यात करें
...
- ए [स्नैपचैट बिजनेस अकाउंट](https://business.snapchat.com/), एक [स्नैपचैट विज्ञापन खाता](https://ads.snapchat.com/), और संबंधित व्यवस्थापक क्रेडेंशियल। आपको कम से कम एक संगठन खाते का सदस्य और एक विशिष्ट विज्ञापन खाते का डेटा प्रबंधक होना चाहिए।
- स्नैपचैट में कम से कम एक ऑडिएंस SAM प्रकार का ऑडिएंस प्रबंधक (स्नैप ऑडिएंस Match)।
- [स्नैपचैट सेगमेंट/ऑडिएंस आईडी।](https://businesshelp.snapchat.com/s/article/custom-audiences) स्नैपचैट ऑडिएंस मैनेजर में ऑडिएंस को चुनने के बाद ऑडिएंस की आईडी URL में पाई जा सकती है।
...
- 1 मिलियन ग्राहक प्रोफाइल तक, जिसे पूरा होने में 15 मिनट तक का समय लग सकता है।
- केवल खंड।
...
1. चुनना**कनेक्शन जोड़ें** और चुनें **Snapchat**.
...
1. **निर्यात के लिए कनेक्शन** में, Snapchat अनुभाग से एक कनेक्शन का चयन करें. यदि कोई कनेक्शन उपलब्ध नहीं है तो किसी व्यवस्थापक से संपर्क करें.

1. निर्यात के लिए एक नाम दर्ज करें।

1. उसे दर्ज करें **स्नैपचैट सेगमेंट/ऑडिएंस आईडी**.
