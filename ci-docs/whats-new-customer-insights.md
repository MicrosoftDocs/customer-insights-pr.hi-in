...
### <a name="updated-data-unification-experience"></a>अद्यतन डेटा एकीकरण अनुभव
 ...
 डेटा एकीकरण आपको एक बार अलग-अलग डेटा स्रोतों को एक एकल मास्टर डेटासेट में एकीकृत करने देता है जो उस डेटा का एकीकृत दृश्य प्रदान करता है। डेटा को एक इकाई या एकाधिक निकायों पर एकीकृत किया जा सकता है। पहले आप [संस्थाओं और स्रोत क्षेत्रों का चयन करें](map-entities.md),[डुप्लिकेट रिकॉर्ड हटाएं](remove-duplicates.md), के लिए नियम निर्दिष्ट करें [मिलान की शर्तें](match-entities.md), और परिभाषित करें जो[एकीकृत ग्राहक प्रोफाइल में शामिल करने के लिए फ़ील्ड।](merge-entities.md)
