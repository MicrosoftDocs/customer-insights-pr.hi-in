---
title: Omnisend में अनुभाग निर्यात करें (पूर्वावलोकन)
...
- एक [सर्वनाम खाता](https://www.omnisend.com/) और संबंधित व्यवस्थापक क्रेडेंशियल।
- एक [ओमनीसेंड एपीआई कुंजी।](https://support.omnisend.com/en/articles/1061890-generating-api-key)
...
- Omnisend को प्रति निर्यात 1 मिलियन ग्राहक प्रोफाइल तक, जिसे पूरा होने में चार घंटे तक लग सकते हैं। Omnisend में निर्यात करने योग्य, ग्राहक प्रोफ़ाइल की संख्या, Omnisend के साथ आपके अनुबंध पर निर्भर करती है.
- केवल खंड।
...
1. चुनना**कनेक्शन जोड़ें** और चुनें **ओमनीसेंड।**
...
1. अपनी Omnisend API कुंजी दर्ज करें.
...
1. **निर्यात के लिए कनेक्शन** फ़ील्ड में, Omnisend सेक्शन से एक कनेक्शन का चयन करें. यदि कोई कनेक्शन उपलब्ध नहीं है तो किसी व्यवस्थापक से संपर्क करें.
...
1. वैकल्पिक रूप से, निर्यात करें **प्रथम नाम**, **िम नाम**, **ा**, **/क्षेत्र**, **ाज्य**, **·**, तथा**पोस्ट कोड** अधिक व्यक्तिगत ईमेल बनाने के लिए। इन फ़ील्ड को मैप करने के लिए **जोड़ें विशेषता** चुनें.
