---
title: डायग्नोस्टिक लॉग निर्यात करें (पूर्वावलोकन)
...
ms.locfileid: "9245927"
---
# <a name="export-diagnostic-logs-preview"></a>डायग्नोस्टिक लॉग निर्यात करें (पूर्वावलोकन)

Azure मॉनिटर का उपयोग करके Customer Insights से लॉग अग्रेषित करें। Azure मॉनिटर संसाधन लॉग आपको मॉनिटर करने और लॉग भेजने की सुविधा देता है [एज़्योर स्टोरेज](https://azure.microsoft.com/services/storage/),[Azure लॉग एनालिटिक्स](/azure/azure-monitor/logs/log-analytics-overview), या उन्हें स्ट्रीम करें [अज़ूर इवेंट हब](https://azure.microsoft.com/services/event-hubs/).

Customer Insights निम्न इवेंट लॉग भेजता है:

- **लेखापरीक्षा कार्यक्रम**
  - **एपीआईइवेंट** - के माध्यम से परिवर्तन ट्रैकिंग सक्षम करता है Dynamics 365 Customer Insights यूआई।
- **ऑपरेशनल इवेंट्स**
  - **कार्यप्रवाह घटना** - आपको सेट करने देता है [डेटा स्रोत](data-sources.md),[यूनिफाई](data-unification.md),[समृद्ध](enrichment-hub.md), तथा[निर्यात करना](export-destinations.md) अन्य प्रणालियों में डेटा। ये चरण व्यक्तिगत रूप से किए जा सकते हैं (उदाहरण के लिए, एकल निर्यात को ट्रिगर करें)। वे ऑर्केस्ट्रेटेड भी चला सकते हैं (उदाहरण के लिए, डेटा स्रोतों से डेटा रीफ्रेश जो एकीकरण प्रक्रिया को ट्रिगर करता है, जो संवर्धन में खींचेगा और डेटा को किसी अन्य सिस्टम में निर्यात करेगा)। अधिक जानकारी के लिए देखें [वर्कफ़्लोइवेंट स्कीमा](#workflow-event-schema).
  - **एपीआईइवेंट** - ग्राहकों के उदाहरण के सभी एपीआई कॉल भेजता है Dynamics 365 Customer Insights. अधिक जानकारी के लिए देखें [एपीआईइवेंट स्कीमा](#api-event-schema).

## <a name="set-up-the-diagnostic-settings"></a>नैदानिक सेटिंग सेट करें

### <a name="prerequisites"></a>पूर्वावश्यकताएँ

- सक्रिय [Azure सदस्यता](https://azure.microsoft.com/pricing/purchase-options/pay-as-you-go/).
- [प्रशासक](permissions.md#admin) Customer Insights में अनुमतियाँ।
- [सहयोगी और यूजर एक्सेस एडमिनिस्ट्रेटर की भूमिका](/azure/role-based-access-control/role-assignments-portal) Azure पर गंतव्य संसाधन पर। संसाधन एक हो सकता है Azure Data Lake Storage खाता, Azure ईवेंट हब या Azure लॉग एनालिटिक्स कार्यस्थान। Customer Insights में नैदानिक सेटिंग्स को कॉन्फ़िगर करते समय यह अनुमति आवश्यक है, लेकिन सफल सेटअप के बाद इसे बदला जा सकता है।
- [गंतव्य आवश्यकताएं](/azure/azure-monitor/platform/diagnostic-settings#destination-requirements) Azure संग्रहण के लिए, Azure Event Hub, या Azure Log Analytics मिले हैं।
- कम से कम **रीडर** उस संसाधन समूह पर भूमिका जिससे संसाधन संबंधित है।

### <a name="set-up-diagnostics-with-azure-monitor"></a>Azure मॉनिटर के साथ निदान सेट करें

1. Customer Insights में, यहाँ जाएँ **व्यवस्थापक** > **व्यवस्था** और चुनें **निदान** टैब।

1. चुनना**गंतव्य जोड़ें**.

   :::image type="content" source="media/diagnostics-pane.png" alt-text="निदान कनेक्शन।":::

1. में एक नाम प्रदान करें **निदान गंतव्य के लिए नाम** खेत।

1. को चुनिए **संसाधन प्रकार** (स्टोरेज अकाउंट, इवेंट हब या लॉग एनालिटिक्स)।

1. को चुनिए **अंशदान**, **ाधन समूह**, तथा**संसाधन** गंतव्य संसाधन के लिए। देखना[गंतव्य संसाधन पर विन्यास](#configuration-on-the-destination-resource) अनुमति और लॉग जानकारी के लिए।
...
संसाधन प्रकार की आपकी पसंद के आधार पर, निम्नलिखित परिवर्तन स्वतः होते हैं:
...
Customer Insights सेवा प्रिंसिपल को मिलता है **Azure इवेंट हब डेटा स्वामी** संसाधन पर अनुमति देता है और चयनित नाम स्थान के अंतर्गत दो इवेंट हब बनाता है:
...
Customer Insights सेवा प्रिंसिपल को मिलता है **लॉग एनालिटिक्स सहयोगी** संसाधन पर अनुमति। लॉग के तहत उपलब्ध हैं **लॉग्स** > **टेबल** > **लॉग प्रबंधन** चयनित लॉग एनालिटिक्स कार्यस्थान पर। इसका विस्तार करें **लॉग प्रबंधन** समाधान और पता लगाएँ`CIEventsAudit` तथा`CIEventsOperational` टेबल।
...
## <a name="remove-a-diagnostics-destination"></a>निदान गंतव्य निकालें

1. के लिए जाओ **व्यवस्थापक** > **व्यवस्था** और चुनें **निदान** टैब।

1. सूची में निदान गंतव्य का चयन करें।

   > [!TIP]
   > गंतव्य को हटाने से लॉग अग्रेषण बंद हो जाता है, लेकिन Azure सदस्यता पर संसाधन नहीं हटता है। Azure में संसाधन को हटाने के लिए, में लिंक का चयन करें **कार्रवाई** चयनित संसाधन के लिए Azure पोर्टल खोलने और उसे वहां हटाने के लिए कॉलम। फिर डायग्नोस्टिक्स डेस्टिनेशन को डिलीट करें।

1. में **कार्रवाई** कॉलम, चुनें **मिटाना** चिह्न।

1. गंतव्य को हटाने और लॉग अग्रेषण को रोकने के लिए हटाने की पुष्टि करें।
...
API ईवेंट और वर्कफ़्लो ईवेंट की संरचना एक समान होती है, लेकिन कुछ अंतरों के साथ। अधिक जानकारी के लिए देखें [एपीआई घटना स्कीमा](#api-event-schema) या[वर्कफ़्लो इवेंट स्कीमा](#workflow-event-schema).
...
| `Claims`                      | उपयोगकर्ता या ऐप JSON वेब टोकन (JWT) के दावे। दावा गुण प्रति संगठन भिन्न होते हैं और Azure Active Directory विन्यास। |
...
वर्कफ़्लो में कई चरण होते हैं। [डेटा स्रोत निगलना](data-sources.md),[यूनिफाई](data-unification.md),[समृद्ध](enrichment-hub.md), तथा[निर्यात करना](export-destinations.md) जानकारी। वे सभी चरण व्यक्तिगत रूप से चल सकते हैं या निम्नलिखित प्रक्रियाओं के साथ व्यवस्थित हो सकते हैं।
...
| `properties.operationType`                   | हां      | हां  | ऑपरेशन का पहचानकर्ता, देखें [ऑपरेशन के प्रकार](#operation-types).                                                                                                                                                                               |
...
| `properties.additionalInfo.entityCount`      | No       | हां  | ऑप्शनल. ऑपरेशन टाइप के लिए`Segmentation` केवल। खंड में सदस्यों की कुल संख्या को इंगित करता है।                                                                                                                                                    |
