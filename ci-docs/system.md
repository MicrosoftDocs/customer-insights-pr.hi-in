---
title: Customer Insights में सिस्टम कॉन्फ़िगरेशन
...
ms.locfileid: "8653618"
---
# <a name="system-configuration"></a>सिस्टम कॉन्फ़िगरेशन

सिस्टम कॉन्फ़िगरेशन तक पहुंचने के लिए, यहां जाएं **व्यवस्थापक** > **प्रणाली** सिस्टम कार्यों और प्रक्रियाओं की सूची देखने के लिए।
...
में कार्य या प्रक्रिया के आगे की स्थिति का चयन करें **स्थिति** कॉलम खोलने के लिए **प्रगति विवरण** फलक
...
|स्थिति  |परिभाषा  |
|---------|---------|
|रद्द किया गया |प्रसंस्करण समाप्त होने से पहले उपयोगकर्ता द्वारा रद्द कर दिया गया था।   |
...
1. के लिए जाओ **व्यवस्थापक** > **प्रणाली** और चुनें **अनुसूची** टैब।
...
-  **ऑपरेशन** - प्रत्येक उपलब्ध API ऑपरेशन के लिए पंक्तियों के साथ एक टेबल और ऑपरेशन के उपयोग के बारे में विवरण. आप [API संदर्भ](https://developer.ci.ai.dynamics.com/api-details#api=CustomerInsights&operation=Get-all-instances) पर जाने के लिए एक ऑपरेशन नाम का चयन कर सकते हैं.
   ...
   संचालन जो उपयोग करते हैं [रीयल-टाइम डेटा अंतर्ग्रहण](real-time-data-ingestion.md) रीयल-टाइम API उपयोग देखने के लिए दूरबीन चिह्न वाला एक बटन होता है। मौजूदा परिवेश में रीयल-टाइम API उपयोग के लिए उपयोग विवरण युक्त साइड फलक खोलने के लिए बटन चुनें.   
