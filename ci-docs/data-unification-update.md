...
1. के लिए जाओ **जानकारी** > **एकजुट।**
   ...
   > [!TIP]
   > **मिलान की शर्तें** टाइल केवल तभी प्रदर्शित होती है जब एक से अधिक निकायों का चयन किया गया हो।
...
1. अपने परिवर्तन करने के बाद, अपना अगला विकल्प चुनें:
   ...
   - [ग्राहक प्रोफाइल को एकीकृत करें](#run-updates-to-the-unified-customer-profile) निर्भरताओं (जैसे संवर्धन, खंड, या उपाय) को प्रभावित किए बिना मेल खाने वाली स्थितियों को चलाने और एकीकृत ग्राहक प्रोफ़ाइल इकाई को अद्यतन करने के लिए। आश्रित प्रक्रियाएं नहीं चलती हैं, लेकिन इस रूप में ताज़ा की जाएंगी[रिफ्रेश शेड्यूल में परिभाषित](schedule-refresh.md).
...
आप मिलान के अधिकांश मापदंडों को फिर से कॉन्फ़िगर और सुधार सकते हैं. आप निकायों को जोड़ या हटा नहीं सकते हैं. मिलान के नियम किसी एक इकाई पर लागू नहीं होते हैं।
...
1. नियम प्रबंधित करने के लिए, निम्न में से कोई भी विकल्प चुनें:
   ...
   - **नियम की शर्तें बदलें** : नियम चुनें और फिर **संपादन करना**. फ़ील्ड बदलें, शर्तें जोड़ें या निकालें या अपवाद जोड़ें या निकालें.
   - **एक नियम निष्क्रिय करें** : नियम चुनें और फिर **निष्क्रिय करें** मिलान प्रक्रिया से बाहर रखते हुए मिलान नियम को बनाए रखने के लिए।
   - **एक नियम की नकल करें** : नियम चुनें और फिर **डुप्लिकेट** संशोधनों के साथ एक समान नियम बनाने के लिए।
   - **एक नियम हटाएं** : नियम चुनें और फिर **मिटाना**.
...
रन मैचिंग कंडीशंस केवल डिडुप्लिकेशन और मैच रूल्स को रन करती हैं और अपडेट करती हैं *डुप्लीकेशन_* * तथा*ConflationMatchPair* संस्थाएं।
...
1. से **जानकारी** > **यूनिफाई** पेज, चुनें:
   ...
   - **ग्राहक प्रोफाइल को एकीकृत करें** : मेल खाने वाली स्थितियों को चलाता है और निर्भरता को प्रभावित किए बिना एकीकृत ग्राहक प्रोफ़ाइल इकाई को अपडेट करता है (जैसे संवर्धन, खंड या उपाय)। आश्रित प्रक्रियाएं नहीं चलती हैं, लेकिन इस रूप में ताज़ा की जाएंगी[रिफ्रेश शेड्यूल में परिभाषित](schedule-refresh.md).
