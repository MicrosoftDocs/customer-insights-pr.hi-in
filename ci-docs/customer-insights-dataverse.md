...
1. एक्सेस कंट्रोल लिस्ट (ACL) को प्रबंधित करें`customerinsights` इन सुरक्षा समूहों के माध्यम से आपके संग्रहण खाते में कंटेनर।
   ...
   1. जोड़ें *केवल* को Customers Insights आवेदन **सहयोगी** दोनों को अनुदान देने के लिए सुरक्षा समूह **पढ़ें और लिखें** प्रोफाइल और अंतर्दृष्टि लिखने की अनुमति।
