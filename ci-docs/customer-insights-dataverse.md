...
मान लें कि आपको प्रति 100,000 ग्राहक प्रोफाइल पर 15 जीबी डेटाबेस स्टोरेज और 20 जीबी फाइल स्टोरेज मिलती है। यदि आपकी सदस्यता में 300,000 ग्राहक प्रोफ़ाइल शामिल हैं, तो आपकी कुल संग्रहण क्षमता 45 GB (3 x 15 GB) डेटाबेस संग्रहण और 60 GB फ़ाइल संग्रहण (3 x 20 GB) होगी। इसी तरह, यदि आपके पास 30K खातों के साथ B2B सदस्यता है, तो आपकी कुल संग्रहण क्षमता 45 GB (3 x 15 GB) डेटाबेस संग्रहण और 60 GB फ़ाइल संग्रहण (3 x 20 GB) होगी।
...
व्यवस्थापक किसी मौजूदा को जोड़ने के लिए Customer Insights को कॉन्फ़िगर कर सकते हैं Dataverse वातावरण। को URL प्रदान करके Dataverse परिवेश, यह उनके नए Customer Insights परिवेश से जुड़ रहा है। Customer Insights और . के बीच संबंध स्थापित करने के बाद Dataverse, के लिए संगठन का नाम न बदलें Dataverse वातावरण। संगठन के नाम में प्रयोग किया जाता है Dataverse URL और बदला हुआ नाम Customer Insights से संबंध तोड़ देता है।
...
- यदि आपके एक्सेस करने के लिए Azure प्राइवेट लिंक सेटअप की आवश्यकता है तो डेटा साझाकरण कार्य नहीं करेगाAzure Data Lake Storage खाता क्योंकि यह फ़ायरवॉल के पीछे है। Dataverse वर्तमान में निजी लिंक के माध्यम से निजी समापन बिंदुओं से कनेक्शन का समर्थन नहीं करता है।
