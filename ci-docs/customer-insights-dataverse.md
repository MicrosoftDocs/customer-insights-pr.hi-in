...
- यदि आपके Azure डेटा लेक संग्रहण खाते तक पहुँचने के लिए Azure Private Link सेटअप की आवश्यकता है, तो डेटा साझाकरण काम नहीं करेगा क्योंकि यह फ़ायरवॉल के पीछे है। Dataverse वर्तमान में निजी लिंक के माध्यम से निजी समापन बिंदुओं से कनेक्शन का समर्थन नहीं करता है।
