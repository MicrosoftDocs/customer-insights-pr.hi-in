...
> [!NOTE]
> यदि आपके संगठन पहले से उपयोग करते हैं Dataverse उनके किरायेदार में, यह याद रखना महत्वपूर्ण है कि[Dataverse पर्यावरण निर्माण एक व्यवस्थापक द्वारा नियंत्रित किया जाता है](/power-platform/admin/control-environment-creation) . उदाहरण के लिए, यदि आप अपने संगठनात्मक खाते के साथ एक नया Customer Insights परिवेश स्थापित कर रहे हैं और व्यवस्थापक ने इसके निर्माण को अक्षम कर दिया है Dataverse व्यवस्थापकों को छोड़कर सभी के लिए परीक्षण वातावरण, आप एक नया परीक्षण वातावरण नहीं बना सकते।
> 
