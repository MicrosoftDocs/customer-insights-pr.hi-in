...
### <a name="how-do-i-sign-up-for-the-trial-without-a-microsoft-365-tenant"></a>मैं बिना a . के परीक्षण के लिए कैसे साइन अप करूं?Microsoft 365 किराएदार?
...
- Customer Insights के परीक्षण संस्करण के दौरान आउटपुट डेटा संग्रहीत करने के लिए आप अपने स्वयं के Azure Data Lake संग्रहण खाते का उपयोग नहीं कर सकते हैं। हालांकि, आप Data Lake Storage खाते से डेटा अंतर्ग्रहण कर सकते हैं.
