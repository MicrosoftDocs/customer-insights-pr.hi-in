...
1. टोकन को सफलतापूर्वक प्रमाणित करने और प्राप्त करने के बाद, एक नया निर्माण करें या किसी मौजूदा का उपयोग करें`HttpClient` अतिरिक्त के साथ **DefaultRequestHeaders "प्राधिकरण"** करने के लिए सेट **वाहक "पहुँच टोकन"** और **Ocp-Apim-सदस्यता-कुंजी** पर सेट करें [**सदस्यता कुंजी** आपके Customer Insights परिवेश से](#get-started-trying-the-customer-insights-apis).   
