...
1. के लिए जाओ **जानकारी** > **संबंध** आप जिस परिवेश में गायब हैं, उस पर Power BI.
...
MM/DD/YYYY जैसे दिनांक फॉर्मेट वाले फ़ील्ड वाले निकायों को लोड करते समय, बेमेल स्थानीय फॉर्मेट के कारण आपको त्रुटियों का सामना करना पड़ सकता है. यह बेमेल तब होता है जब आपकाPower BI Desktop फ़ाइल अंग्रेज़ी (संयुक्त राज्य) के स्थान पर किसी अन्य स्थान पर सेट है, क्योंकि Customer Insights में दिनांक फ़ील्ड US स्वरूप में सहेजी जाती हैं।
